...
- Database 工作台：统一管理“全部文档”和自定义数据库，支持 Table / Board / Cards、字段抽屉、组合筛选、多字段排序、分组、完整保存视图和批量编辑。
- 自定义记录：必填标题、可选关联文档、详情抽屉和 Markdown 备份恢复。
...
应用还内置 v3 [主题切换插件](plugins/theme-switcher/README.md)，随应用提供并默认启用，无需单独安装。提供云白、暖纸、青苔、海湾、午夜、紫夜六款配色，在配置中心即时切换并保存，停用后恢复应用原有外观。
