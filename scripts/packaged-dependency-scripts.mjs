...
if (process.platform !== 'win32') throw new Error('Dependency-script acceptance currently requires Windows.')
...
process.exitCode = await new Promise((resolve, reject) => {
  const child = spawn(process.execPath, [
    ...
    'system-plugins-dependency-scripts.spec.ts', '--reporter=list', '--output=test-results/dependency-scripts'
