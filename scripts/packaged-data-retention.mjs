...
if (process.platform !== 'win32') throw new Error('Data retention acceptance currently requires Windows.')
...
process.exitCode = await new Promise((resolve, reject) => {
  const child = spawn(process.execPath, [join(root, 'node_modules/@playwright/test/cli.js'), 'test',
    'system-plugins-data-retention.spec.ts', '--reporter=list', '--output=test-results/data-retention'],
