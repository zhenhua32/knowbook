...
if (process.platform !== 'win32') throw new Error('System capability acceptance currently requires Windows.')
...
process.exitCode = await new Promise((resolve, reject) => {
  const child = spawn(process.execPath, [
    ...
    'system-plugins-capabilities.spec.ts', '--reporter=list', '--output=test-results/system-capabilities'
