...
const api: ElectronApi = {
  ...
  checkDocumentLinks: (documentId: string) => ipcRenderer.invoke('knowbook:check-document-links', documentId) as Promise<DocumentLinkCheck>,
  ...
  getPluginV2Details: (input: GetPluginV2DetailsInput) => ipcRenderer.invoke('knowbook:get-plugin-v2-details', input) as Promise<PluginV2Details>,
  ...
  setPluginV2Enabled: (input: SetPluginV2EnabledInput) => ipcRenderer.invoke('knowbook:set-plugin-v2-enabled', input) as Promise<void>,
  removePluginV2: (input: RemovePluginV2Input) => ipcRenderer.invoke('knowbook:remove-plugin-v2', input) as Promise<void>,
  ...
  chooseAndPrepareSystemPluginInstall: () => ipcRenderer.invoke('knowbook:choose-and-prepare-system-plugin-install') as Promise<SystemPluginInstallRequest | null>,
  ...
  listSystemPlugins: () => ipcRenderer.invoke('knowbook:list-system-plugins') as Promise<SystemPluginSummary[]>,
  setSystemPluginEnabled: (input: SetSystemPluginEnabledInput) => ipcRenderer.invoke('knowbook:set-system-plugin-enabled', input) as Promise<SystemPluginSummary>,
  uninstallSystemPlugin: (input: UninstallSystemPluginInput) => ipcRenderer.invoke('knowbook:uninstall-system-plugin', input) as Promise<SystemPluginSummary>,
  recoverSystemPlugin: (input: SystemPluginMutationInput) => ipcRenderer.invoke('knowbook:recover-system-plugin', input) as Promise<SystemPluginSummary>,
  rollbackSystemPlugin: (input: RollbackSystemPluginInput) => ipcRenderer.invoke('knowbook:rollback-system-plugin', input) as Promise<SystemPluginSummary>,
  startSystemPluginService: (input: SystemPluginMutationInput) => ipcRenderer.invoke('knowbook:start-system-plugin-service', input) as Promise<SystemPluginSummary>,
  stopSystemPluginService: (input: SystemPluginMutationInput) => ipcRenderer.invoke('knowbook:stop-system-plugin-service', input) as Promise<SystemPluginSummary>,
  requestSystemPluginOsPersistence: (input: SystemPluginMutationInput) => ipcRenderer.invoke('knowbook:request-system-plugin-os-persistence', input) as Promise<SystemPluginOsPersistenceRecord>,
  resolveSystemPluginOsPersistence: (input: ResolveSystemPluginOsPersistenceInput) => ipcRenderer.invoke('knowbook:resolve-system-plugin-os-persistence', input) as Promise<SystemPluginOsPersistenceRecord>,
  removeSystemPluginOsPersistence: (input: SystemPluginMutationInput) => ipcRenderer.invoke('knowbook:remove-system-plugin-os-persistence', input) as Promise<SystemPluginSummary>,
  openSystemPluginDataDirectory: (input: SystemPluginMutationInput) => ipcRenderer.invoke('knowbook:open-system-plugin-data-directory', input) as Promise<void>,
  openSystemPluginLogDirectory: (input: SystemPluginMutationInput) => ipcRenderer.invoke('knowbook:open-system-plugin-log-directory', input) as Promise<void>,
  restartInSystemPluginSafeMode: () => ipcRenderer.invoke('knowbook:restart-in-system-plugin-safe-mode') as Promise<void>,
  registerSystemPluginFramePolicy: (input: SystemPluginFramePolicyInput) => ipcRenderer.invoke('knowbook:register-system-plugin-frame-policy', input) as Promise<void>,
